...
class ListerProduct extends \Magento\Catalog\Block\Product\AbstractProduct {
    ...
    protected $_template = 'Ibnab_OwlSlider::fslider/listerproduct.phtml';
