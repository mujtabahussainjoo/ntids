...
class RevSliderPluginUpdate {
	...
	public function __construct(
        ...
        self::$revSliderLoadBalancer = $revSliderLoadBalancer;
	...
	/**
	 * Upgrade Duotone, Revealer and Typewriter Add-Ons for compatiblity with 5.4.8.1
	 */
	public static function upgrade_addons_5481() {
		$addons = array(
			'revslider-duotonefilters-addon/revslider-duotonefilters-addon.php',
			'revslider-revealer-addon/revslider-revealer-addon.php',
			'revslider-typewriter-addon/revslider-typewriter-addon.php'
		);
		foreach ($addons as $addon) {
			if (self::$pluginHelper->isPluginActive($addon)) {
				self::$pluginHelper->updatePlugin(self::$revSliderLoadBalancer->get_url('updates'), strstr($addon, '/', true));
			}
		}
	}
