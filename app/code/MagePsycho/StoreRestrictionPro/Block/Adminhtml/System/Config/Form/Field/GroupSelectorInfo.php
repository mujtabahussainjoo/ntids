...
class GroupSelectorInfo extends \Magento\Backend\Block\Template implements RendererInterface
{
    ...
    {
        $info = '<div style="border: 1px solid #D6D6D6;padding:0px 4px 4px 4px;margin:20px 4px 4px 4px;background-color:white"><div style="padding:12px">
Store Restriction Pro bundles another extension <a href="http://www.magepsycho.com/magento-2-store-restriction-pro.html" title="Magento 2 Customer Group Selector / Switcher" target="_blank">Magento 2 Group Selector / Switcher</a> for FREE. It allows users to select/switch to their required customer group at registration, using group drop-down or group code.<br /> In order to customize this feature please go to <a href="' . $this->getUrl('adminhtml/system_config/edit/section/magepsycho_groupswitcherpro') . '" title="Manage Customer Group Selector Settings">Stores > Configuration > MagePsycho Extensions > Group Selector Pro</a> section.
</div></div>';
        return sprintf(
