...
namespace MagePsycho\GroupSwitcherPro\Block\Adminhtml\System\Config\Form\Fieldset;
...
class Support extends \Magento\Backend\Block\Template implements \Magento\Framework\Data\Form\Element\Renderer\RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'MagePsycho_GroupSwitcherPro::system/config/form/fieldset/support.phtml';
    ...
    public function getModuleVersion()
    {
        ...
        $v = "";
        if (isset($modules['MagePsycho_GroupSwitcherPro'])) {
            $v = $modules['MagePsycho_GroupSwitcherPro']['setup_version'];
        }
        return $v;
    }
}