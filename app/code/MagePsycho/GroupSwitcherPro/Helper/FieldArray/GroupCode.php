...
namespace MagePsycho\GroupSwitcherPro\Helper\FieldArray;
...
class GroupCode
{
    ...
    const FIELD_ARRAY_CUSTOMER_GROUP_VALUE  = 'group_code';
    ...
    public function getConfigValue($customerGroupId, $store = null)
    {
        $value = $this->scopeConfig->getValue(
            \MagePsycho\GroupSwitcherPro\Helper\Config::XML_PATH_GROUP_LOGIN_URL,
