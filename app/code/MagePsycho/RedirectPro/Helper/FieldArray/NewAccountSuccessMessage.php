 ...
 */
class NewAccountSuccessMessage
{
    const FIELD_ARRAY_CUSTOMER_GROUP_ID     = 'customer_group_id';
    const FIELD_ARRAY_CUSTOMER_GROUP_VALUE  = 'group_account_message';
    ...
    public function getConfigValue($customerGroupId, $store = null)
    {
        $value = $this->scopeConfig->getValue(
            \MagePsycho\RedirectPro\Helper\Config::XML_PATH_GROUP_ACCOUNT_MESSAGE,
