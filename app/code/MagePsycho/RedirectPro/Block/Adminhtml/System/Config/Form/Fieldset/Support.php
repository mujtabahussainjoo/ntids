...
namespace MagePsycho\RedirectPro\Block\Adminhtml\System\Config\Form\Fieldset;
...
class Support extends \Magento\Backend\Block\Template implements \Magento\Framework\Data\Form\Element\Renderer\RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'MagePsycho_RedirectPro::system/config/form/fieldset/support.phtml';
    ...
    public function getModuleVersion()
    {
        ...
        $v = "";
        if (isset($modules['MagePsycho_RedirectPro'])) {
            $v = $modules['MagePsycho_RedirectPro']['setup_version'];
        }
        return $v;
    }
}