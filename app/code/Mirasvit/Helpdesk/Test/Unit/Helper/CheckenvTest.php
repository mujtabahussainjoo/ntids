...
/**
 * @covers \Mirasvit\Helpdesk\Helper\Checkenv
...
class CheckenvTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->checkenvHelper = $this->objectManager->getObject(
    ...
    {
        $this->assertEquals($this->checkenvHelper, $this->checkenvHelper);
    }
}
