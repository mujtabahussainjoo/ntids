...
/**
 * @covers \Mirasvit\Helpdesk\Controller\Ticket\Postmessage
...
class PostmessageTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Helpdesk\Controller\Ticket\Postmessage|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function setUp()
    {
        ...
        $this->ticketController = $this->objectManager->getObject(
            '\Mirasvit\Helpdesk\Controller\Ticket\Postmessage',
            [
