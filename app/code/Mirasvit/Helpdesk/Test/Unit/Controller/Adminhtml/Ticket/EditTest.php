...
/**
 * @covers \Mirasvit\Helpdesk\Controller\Adminhtml\Ticket\Edit
...
class EditTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Helpdesk\Controller\Adminhtml\Ticket\Edit|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function setUp()
    {
        ...
        $this->ticketController = $this->objectManager->getObject(
            '\Mirasvit\Helpdesk\Controller\Adminhtml\Ticket\Edit',
            [
    ...
    {
        $this->requestMock->method('getParam')->willReturn($this->returnValue('111'));
        $this->ticketMock->method('load')->willReturnSelf(); //empty ticket, without id
        ...
        $this->messageManagerMock
            ->expects($this->once())
            ->method('AddError')
            ->with(__('The ticket does not exist.'))
            ->willReturnSelf();

        $this->assertEquals($this->redirectMock, $this->ticketController->execute());
    }
}
