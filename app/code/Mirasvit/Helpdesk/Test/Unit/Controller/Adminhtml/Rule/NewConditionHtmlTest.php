...
namespace Mirasvit\Helpdesk\Test\Unit\Controller\Adminhtml\Rule;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManager;

/**
 * @covers \Mirasvit\Helpdesk\Controller\Adminhtml\Rule\NewConditionHtml
 * @SuppressWarnings(PHPMD)
 */
class NewConditionHtmlTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    /**
     * @var \Mirasvit\Helpdesk\Controller\Adminhtml\Rule\NewConditionHtml|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $ruleController;

    /**
     * @var \Mirasvit\Helpdesk\Model\RuleFactory|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $ruleFactoryMock;

    /**
     * @var \Mirasvit\Helpdesk\Model\Rule|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $ruleMock;
    ...
    public function setUp()
    {
        $this->ruleFactoryMock = $this->getMock(
            '\Mirasvit\Helpdesk\Model\RuleFactory',
            ['create'],
            [],
            '',
            false
        ...
        $this->ruleController = $this->objectManager->getObject(
            '\Mirasvit\Helpdesk\Controller\Adminhtml\Rule\NewConditionHtml',
            [
