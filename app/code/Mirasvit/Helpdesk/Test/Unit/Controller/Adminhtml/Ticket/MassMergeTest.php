...
/**
 * @covers \Mirasvit\Helpdesk\Controller\Adminhtml\Ticket\MassMerge
 * @SuppressWarnings(PHPMD)
 */
class MassMergeTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    /**
     * @var \Mirasvit\Helpdesk\Controller\Adminhtml\Ticket\MassMerge|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function setUp()
    {
        ...
        $this->ticketController = $this->objectManager->getObject(
            '\Mirasvit\Helpdesk\Controller\Adminhtml\Ticket\MassMerge',
            [
