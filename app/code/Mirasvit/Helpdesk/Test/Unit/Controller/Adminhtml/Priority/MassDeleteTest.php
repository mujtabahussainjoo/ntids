...
namespace Mirasvit\Helpdesk\Test\Unit\Controller\Adminhtml\Priority;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManager;

/**
 * @covers \Mirasvit\Helpdesk\Controller\Adminhtml\Priority\MassDelete
...
class MassDeleteTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Helpdesk\Controller\Adminhtml\Priority\MassDelete|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $priorityController;
    ...
    public function setUp()
    {
        ...
        $this->priorityController = $this->objectManager->getObject(
            '\Mirasvit\Helpdesk\Controller\Adminhtml\Priority\MassDelete',
            [
    ...
    {
        $this->assertEquals($this->priorityController, $this->priorityController);
    }
}
