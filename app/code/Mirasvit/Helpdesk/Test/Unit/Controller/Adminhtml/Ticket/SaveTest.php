...
namespace Mirasvit\Helpdesk\Test\Unit\Controller\Adminhtml\Ticket;

use Magento\Framework\DataObject;
use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManager;

/**
 * @covers \Mirasvit\Helpdesk\Controller\Adminhtml\Ticket\Save
...
class SaveTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Helpdesk\Controller\Adminhtml\Ticket\Save|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function setUp()
    {
        ...
        $this->contextMock->expects($this->any())->method('getAuth')->willReturn($this->authMock);
        ...
        $this->ticketController = $this->objectManager->getObject(
            '\Mirasvit\Helpdesk\Controller\Adminhtml\Ticket\Save',
            [
     ...
     */
    public function testCreateTicketRedirectWhenWeChooseStoreId()
    {
        $data = ['store_id' => 5];

        $this->requestMock
            ->expects($this->any())
            ->method('getParams')->willReturn($data);

        $this->redirectMock
            ->expects($this->once())
            ->method('setPath')
            ->with('*/*/add', ['store_id' => $data['store_id']]);

        $this->ticketController->execute();
    }
    ...
    public function testCreateNewTicket()
    {
        ...
        $ticket = new DataObject($data);
        $ticket->setId(111);

        $this->helpdeskProcessMock
            ->expects($this->once())
            ->method('createOrUpdateFromBackendPost')
            ->with($data, null)
            ->willReturn($ticket);
