...
class DeleteTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/helpdesk/department/delete';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Helpdesk\Controller\Adminhtml\Department\Delete::execute
     */
    public function testDeleteAction()
    {
        $this->dispatch('backend/helpdesk/department/delete');
