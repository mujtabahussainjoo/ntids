...
class DeleteTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/helpdesk/gateway/delete';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Helpdesk\Controller\Adminhtml\Gateway\Delete::execute
     */
    public function testDeleteAction()
    {
        $this->dispatch('backend/helpdesk/gateway/delete');
