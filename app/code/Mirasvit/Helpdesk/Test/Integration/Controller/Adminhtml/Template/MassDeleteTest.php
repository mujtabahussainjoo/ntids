...
class MassDeleteTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/helpdesk/template/massdelete';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Helpdesk\Controller\Adminhtml\Template\MassDelete::execute
     */
    public function testMassDeleteAction()
    {
        $this->dispatch('backend/helpdesk/template/massdelete');
