...
class AddTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/helpdesk/department/add';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Helpdesk\Controller\Adminhtml\Department\Add::execute
     */
    public function testAddAction()
    {
        $this->dispatch('backend/helpdesk/department/add');
