...
class MassChangeTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/helpdesk/rule/masschange';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Helpdesk\Controller\Adminhtml\Rule\MassChange::execute
     */
    public function testMassChangeAction()
    {
        $this->dispatch('backend/helpdesk/rule/masschange');
