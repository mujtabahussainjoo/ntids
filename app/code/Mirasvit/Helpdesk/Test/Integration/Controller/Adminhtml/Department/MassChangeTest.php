...
class MassChangeTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/helpdesk/department/masschange';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Helpdesk\Controller\Adminhtml\Department\MassChange::execute
     */
    public function testMassChangeAction()
    {
        $this->dispatch('backend/helpdesk/department/masschange');
