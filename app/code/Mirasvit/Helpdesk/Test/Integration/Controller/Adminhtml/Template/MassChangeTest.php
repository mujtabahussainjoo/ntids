...
class MassChangeTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/helpdesk/template/masschange';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Helpdesk\Controller\Adminhtml\Template\MassChange::execute
     */
    public function testMassChangeAction()
    {
        $this->dispatch('backend/helpdesk/template/masschange');
