...
class MassChangeTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/helpdesk/gateway/masschange';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Helpdesk\Controller\Adminhtml\Gateway\MassChange::execute
     */
    public function testMassChangeAction()
    {
        $this->dispatch('backend/helpdesk/gateway/masschange');
