...
class MassDeleteTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/helpdesk/rule/massdelete';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Helpdesk\Controller\Adminhtml\Rule\MassDelete::execute
     */
    public function testMassDeleteAction()
    {
        $this->dispatch('backend/helpdesk/rule/massdelete');
