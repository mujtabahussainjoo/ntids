...
class ArchiveTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/helpdesk/ticket/archive';
        parent::setUp();
    }
     ...
     * @covers  Mirasvit\Helpdesk\Controller\Adminhtml\Ticket\Archive::execute
     */
    public function testArchiveAction()
    {
        ...
        $this->dispatch('backend/helpdesk/ticket/archive');
        $this->assertNotEquals('noroute', $this->getRequest()->getControllerName());

        $this->assertSessionMessages(
            $this->contains('Ticket was moved to archive'),
        ...
        $this->assertEquals(Config::FOLDER_ARCHIVE, $ticket->getFolder());
    }
}
