...
class EditTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/helpdesk/department/edit';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Helpdesk\Controller\Adminhtml\Department\Edit::execute
     */
    public function testEditAction()
    {
        $this->markTestIncomplete();
        $this->dispatch('backend/helpdesk/department/edit');
