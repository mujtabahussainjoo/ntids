...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('customerorder');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Serole\Cashback\Model\Customerorder')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('cashback/*/index');
    }
