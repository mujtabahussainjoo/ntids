...
namespace Serole\Adminhtml\Block\User\Edit\Tab;
...
class Main extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    public function __construct(
        ...
        \Magento\Store\Model\System\Store $storeCollection,
    ...
    protected function _prepareForm()
    {
        ...
        $stores = $this->storeCollection->getStoreValuesForForm(false, true);
