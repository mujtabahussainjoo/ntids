...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('memberlist');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Serole\MemberList\Model\Memberlist')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('memberlist/*/index');
    }
