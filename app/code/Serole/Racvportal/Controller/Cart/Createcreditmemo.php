<?php
   ...
   class Createcreditmemo extends \Serole\Racvportal\Controller\Cart\Ajax{
       ...
       public function execute(){
           ...
           try {
               $writer = new \Zend\Log\Writer\Stream(BP . '/var/log/Racvportal-create-creditmemo.log');
               ...
               if ($this->getRequest()->isAjax()) {
                   ...
                   $objectManager->create(\Magento\Sales\Model\Service\CreditmemoService::class)->refund($creditmemo,FALSE);
