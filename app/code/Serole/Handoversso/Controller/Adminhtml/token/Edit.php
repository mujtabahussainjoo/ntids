...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Serole_Handoversso::Token')
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Serole\Handoversso\Model\Token');
        ...
        $this->_coreRegistry->register('token', $model);
