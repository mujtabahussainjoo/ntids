...
class Report extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('magedelight_membership_products', 'membership_product_id');
    }
     ...
     * @return $this
     */
    public function init($table, $field = 'membership_product_id')
    {
    ...
    /**
     * Process brand details before saving
     *
