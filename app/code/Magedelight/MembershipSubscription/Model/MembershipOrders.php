...
class MembershipOrders extends AbstractModel
{
    ...
    {
        $this->_init('Magedelight\MembershipSubscription\Model\ResourceModel\MembershipOrders');
    }
     ...
     * Set Id.
     */
    public function setMembershipProductId($membership_order_id)
    {
