...
namespace Magedelight\MembershipSubscription\Block\Adminhtml\Grid;
...
class AbstractGrid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        $resourceCollection = $this->_resourceFactory->create(
            ...
            $filterData->getData('membership_plan')
        )->addStoreFilter(
            $storeIds
     ...
     *
     * @param \Sales\Reports\Model\ResourceModel\Report\Collection\AbstractCollection $collection
     * @param \Magento\Framework\DataObject $filterData
     * @return $this
     */
    protected function _addOrderStatusFilter($collection, $filterData)
    {
        $collection->addOrderStatusFilter($filterData->getData('membership_plan'));
        return $this;
    }
